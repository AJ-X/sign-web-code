...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-gears"> 添加耗材</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 添加耗材 > <a href="<?php echo U('index/main');?>">首页</a></dl>
    ...
    <div class="fbneirong">
      <form class="am-form" enctype="multipart/form-data" action="<?php echo U('haocaitianjia');?>" method="post">
        <div class="am-form-group am-cf">
          <div class="zuo">名称:</div>
          <div class="you">
            <input type="text" name="name" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入耗材名称">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">价格:</div>
          <div class="you">
            <input type="tel" name="price" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="请输入价格">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">图片:</div>
          <div class="you">
            <input type="file" name="img" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="请选择图片">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="you" style="margin-left: 11%;">
              <button type="submit" class="am-btn am-btn-success am-radius">添加</button>&nbsp;  &raquo; &nbsp; <button type="reset" class="am-btn am-btn-secondary am-radius">重置</button>
          </div>
        </div>
      </form>
    </div> 
