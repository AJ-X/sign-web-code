...
<div class="admin" style="margin-top: -35px;">
    <div class="admin-biaoge" style="width: 90%;margin-top: 20%;margin-left: 5%;">
           <h1 style="text-align: center;">标记后台管理系统</h1>
           <h2 style="text-align: center;">管理员：<?php echo (session('adminname')); ?> 您好！</h2>
           <h3 style="text-align: center;">登录时间：<?php echo (date("Y-m-d H:i:s",session('time'))); ?></h3>
      </div>
    </div>
