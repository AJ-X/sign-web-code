...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on"> 修改物流状态</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 修改物流状态 > <a href="<?php echo U('index/main');?>">首页</a></dl>
    </div>
  
    <div class="fbneirong">
      <form class="am-form" enctype="multipart/form-data" action="<?php echo U('wuliuxiugai');?>" method="post">
