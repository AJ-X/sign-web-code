...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 修改用户 > <a href="<?php echo U('index/main');?>">首页</a></dl>
    </div>
  
    <div class="fbneirong">
      <form class="am-form" enctype="multipart/form-data" action="<?php echo U('yonghuxiugai');?>" method="post">
        <input type="hidden" name="id" class="am-input-sm" id="doc-ipt-email-1" value="<?php echo ($re["id"]); ?>">
        <div class="am-form-group am-cf">
          <div class="zuo">用户名:</div>
          <div class="you">
            <input type="text" name="username" class="am-input-sm" id="doc-ipt-email-1" value="<?php echo ($re["username"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">手机:</div>
          <div class="you">
            <input type="tel" name="phone" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["phone"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">邮箱:</div>
          <div class="you">
            <input type="email" name="email" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["email"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">QQ:</div>
          <div class="you">
            <input type="text" name="qq" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["qq"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">微信:</div>
          <div class="you">
            <input type="text" name="wechat" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["wechat"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">微博:</div>
          <div class="you">
            <input type="text" name="weibo" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["weibo"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">积分:</div>
          <div class="you">
            <input type="text" name="number" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["number"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">等级:</div>
          <div class="you">
            <input type="text" name="grade" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["grade"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
