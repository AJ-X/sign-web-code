...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-users"> 修改收货地址</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 修改收货地址 > <a href="<?php echo U('index/main');?>">首页</a></dl>
    </div>
  
    <div class="fbneirong">
      <form class="am-form" enctype="multipart/form-data" action="<?php echo U('shouhuoxiugai');?>" method="post">
        <input type="hidden" name="id" class="am-input-sm" id="doc-ipt-email-1" value="<?php echo ($re["id"]); ?>">
        <div class="am-form-group am-cf">
          <div class="zuo">用户名:</div>
          <div class="you">
            <input type="text" name="username" readonly="readonly" class="am-input-sm" id="doc-ipt-email-1" value="<?php echo ($res["username"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">地址:</div>
          <div class="you">
            <input type="text" name="address" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["address"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
