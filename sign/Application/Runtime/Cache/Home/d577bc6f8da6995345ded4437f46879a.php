...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 进度列表 > <a href="<?php echo U('index/main');?>">首页</a></dl>
    </div>

    <form class="am-form am-g" action="<?php echo U('jinduliebiao');?>" method="post">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-date am-hide-sm-only">申请进度</th>
              </tr>
            </thead>
            <tbody>
