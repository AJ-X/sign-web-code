...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on"> 修改申请进度</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 修改申请进度 > <a href="<?php echo U('index/main');?>">首页</a></dl>
    </div>
  
    <div class="fbneirong">
      <form class="am-form" enctype="multipart/form-data" action="<?php echo U('jinduxiugai');?>" method="post">
        ...
        <div class="am-form-group am-cf">
          <div class="zuo">申请信息:</div>
          <div class="you">
            <input type="text" readonly="readonly" name="message" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["message"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
        ...
        <div class="am-form-group am-cf">
          <div class="zuo">申请进度:</div>
          <div class="you">
            <input type="text" name="status" class="am-input-sm" id="doc-ipt-pwd-1" value="<?php echo ($re["status"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
